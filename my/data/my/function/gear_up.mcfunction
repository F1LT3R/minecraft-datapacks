...
give @s minecraft:book 64
give @s minecraft:chest 64

give @s minecraft:cyan_shulker_box[container=[{slot:0,item:{id:netherite_block,count:64}}, {slot:1,item:{id:obsidian,count:64}}, {slot:2,item:{id:crying_obsidian,count:64}}, {slot:3,item:{id:red_nether_bricks,count:64}}, {slot:4,item:{id:red_nether_brick_stairs,count:64}}, {slot:5,item:{id:red_nether_brick_slab,count:64}}, {slot:6,item:{id:red_nether_brick_wall,count:64}}, {slot:7,item:{id:bedrock,count:64}}, {slot:8,item:{id:barrier,count:64}}, {slot:9,item:{id:cracked_nether_bricks,count:64}}, {slot:10,item:{id:chiseled_nether_bricks,count:64}}, {slot:11,item:{id:gilded_blackstone,count:1}}, {slot:12,item:{id:nether_bricks,count:64}}, {slot:13,item:{id:nether_brick_stairs,count:64}}, {slot:14,item:{id:nether_brick_slab,count:64}}, {slot:15,item:{id:nether_brick_wall,count:64}}, {slot:16,item:{id:nether_brick_fence,count:64}}, {slot:17,item:{id:stone,count:64}}, {slot:18,item:{id:iron_bars,count:64}}, {slot:19,item:{id:iron_door,count:64}}, {slot:20,item:{id:iron_trapdoor,count:64}}, {slot:21,item:{id:amethyst_block,count:64}}, {slot:22,item:{id:glass,count:64}}, {slot:24,item:{id:chain,count:64}}, {slot:25,item:{id:soul_lantern,count:64}}, {slot:26,item:{id:sea_lantern,count:64}}, {slot:23,item:{id:waxed_oxidized_copper_grate,count:64}}],custom_name='["", {"text":"Base Building","italic":false}]']

give @a minecraft:red_shulker_box[container=[{slot:0,item:{id:command_block,count:64}}, {slot:1,item:{id:stone_button,count:64}}, {slot:2,item:{id:lectern,count:64}}, {slot:3,item:{id:sculk_sensor,count:64}}, {slot:4,item:{id:redstone,count:64}}, {slot:5,item:{id:comparator,count:64}}, {slot:6,item:{id:repeater,count:64}}, {slot:7,item:{id:redstone_torch,count:64}}, {slot:8,item:{id:warped_button,count:64}}, {slot:9,item:{id:warped_pressure_plate,count:64}}, {slot:10,item:{id:light_weighted_pressure_plate,count:64}}, {slot:11,item:{id:heavy_weighted_pressure_plate,count:64}}, {slot:12,item:{id:tripwire_hook,count:64}}, {slot:13,item:{id:string,count:64}}, {slot:14,item:{id:daylight_detector,count:64}}, {slot:15,item:{id:piston,count:64}}, {slot:16,item:{id:sticky_piston,count:64}}, {slot:17,item:{id:dispenser,count:64}}, {slot:18,item:{id:dropper,count:64}}, {slot:19,item:{id:observer,count:64}}, {slot:20,item:{id:sculk_shrieker,count:64}}, {slot:21,item:{id:white_wool,count:64}}, {slot:22,item:{id:slime_block,count:64}}, {slot:23,item:{id:honey_block,count:64}}, {slot:24,item:{id:redstone_block,count:64}}, {slot:25,item:{id:lever,count:64}}, {slot:26,item:{id:calibrated_sculk_sensor,count:64}}],custom_name='["", {"text":"Redstone Building","italic":false}]']
